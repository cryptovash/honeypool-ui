    ...
    <div className='max-w-screen-xl w-full mx-auto z-500'>
      <div className={'flex items-center justify-between text-gray-400 px-4 py-3'}>
        <div className={'flex items-center'}>
          ...
          <Link href='/'>
            <a className='text-xs sm:text-xl flex items-center font-barlow font-semibold text-white hover:text-yellow-600 duration-200 ml-2'>
              {APPLICATION_EMOJI}
              <div className='text-xs sm:text-xl flex items-center font-barlow font-semibold text-black'>''</div>
              {APPLICATION_NAME}
            </a>
          </Link>
        </div>
