...
export const PodAdminClaimTokenDrop = ({
  ...
  return (
    <div className='flex items-center '>
      <button
        className='btn btn-yellow tag tag-yellow bg-yellow-700 mr-1 text-white text-xs'
...
const TooltipDisplay = (props) => {
  return (
    <div className={TOOLTIP_CLASSNAMES}>
      <h4 className='text-xl'>Claim Hive Pool</h4>
      <p className='text-xs'>
        To distribute the reward token (i.e. HNYP) the hive must first claim the HNYP and allocate
        the new tokens to current hive users.
      </p>
    </div>
  )
}
