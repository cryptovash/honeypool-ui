...
const PodCard = ({
  ...
  const classNameContainerComposed = classnames(
    'bg-yellow-900 bg-opacity-30 bg-blur p-10 px-10 lg:px-20 relative card-pods shadow-xl',
    classNameContainer
  )
    ...
    <>
      <div className={classNameContainerComposed}>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 lg:gap-x-6 text-center lg:text-left'>
          <div className='col-span-3 text-yellow-600'>
            <div className='flex flex-col lg:flex-row lg:items-center'>
              ...
              <span className='tag tag-white mt-2 lg:mt-0 lg:ml-2 self-center'>Weekly Prize</span>
            </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-x-10 gap-y-6'>
          {/* Grid 1 */}
          <div className='text-yellow-600 text-center lg:text-left'>
            ...
            <span className='block'>
              <span className='text-xxs'>Share of Hive:</span>
          ...
          {calculateDisplayStatus && (
            <>
              {/* Grid 2 */}
              <div className='text-yellow-600 text-center lg:text-left'>
                <span className='block text-xxs'>My share (upon winning prize):</span>
                <span className='block text-white'>
                  <PodUserShareOfPrize
                    className='text-2xl'
                    address={address}
              ...
              <div className='text-yellow-600 text-center lg:text-left'>
                ...
                <span className='block'>
                  <span className='text-xxs'>
                    Rewards in <img className='inline' src='/tokens/token-hnyp.png' width={14} />{' '}
              ...
              {/* Grid 4 */}
              <div className='text-yellow-600 text-center lg:text-left'>
                <span className='block text-xxs'>Claimable HNYP:</span>
                <span className='block text-white'>
                  <UserClaimablePoolViaTokenDrop
                    className='text-2xl'
        ...
        {isOpen && (
          <div className='grid grid-cols-1 lg:grid-cols-4 gap-x-10 gap-y-6 row-second mt-10'>
            {/* Grid 1 */}
            <div className='text-yellow-600 text-center lg:text-left'>
              <span className='block text-xxs'>Hive Balance</span>
              <span className='block text-white'>
                <PodBalanceTotal
                  className='text-2xl'
                  address={address}
            ...
            {/* Grid 4 */}
            <div className='text-yellow-600 text-center lg:text-left'>
              <span className='block text-xxs'>Hive Claimable HNYP</span>
...
const ExpandButton = ({ isOpen, isTabletOrMobile, toggleIsOpen }) => {
  const styleAbsolute = classnames('absolute right-0 cursor-pointer', {
    'bg-yellow-700 hover:bg-yellow-600 bg-opacity-20 duration-200 rounded-xl right-2 h-12 w-12 flex flex-center':
      isTabletOrMobile
  })

  const styleContainer = classnames('block cursor-pointer text-white text-xxs text-center', {
    'bg-yellow-900 hover:bg-yellow-700 bg-opacity-90 duration-200 -bottom-6 rounded-b-lg py-1 px-5':
      !isTabletOrMobile,
...
const PodCardLoading = ({ classNameContainer, symbol, tokenImage, isError, ...props }) => {
  const classNameContainerComposed = classnames(
    'bg-yellow-900 bg-opacity-30 bg-blur p-10 px-10 lg:px-20 text-center text-white text-opacity-80 shadow-xl',
    classNameContainer
  )
...
const PodFloatTooltip = (props) => {
  return (
    <div className={TOOLTIP_CLASSNAMES}>
      <h4 className='text-xl'>Hive Float</h4>
...
const PodPoolTooltip = (props) => {
  return (
    <div className={TOOLTIP_CLASSNAMES}>
      <h4 className='text-xl'>Pod HNYP - Fair Token Distribution</h4>
      <p className='text-xxs'>
