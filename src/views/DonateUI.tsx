...
const Title = () => (
  <div className='flex flex-col items-center justify-center mt-4 sm:mt-10 mb-4 sm:mb-12 px-8'>
    ...
    <h4 className='opacity-80 text-center'>Honey Pool No Loss Donation</h4>
  </div>
)
...
const InfoCard = (props) => {
  return (
    <Card className={props.className}>
      ...
      <p className='sm:text-sm'>
        With every dollar you deposit, Honey Pool gives you a chance to win that resets every day.
